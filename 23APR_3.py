...
for ip in ip_lst:
    ...
    if device_type == "cisco_ios":
        ...
        enscp = ssh123.send_command("ip scp server enable")
        transfer123 = file_transfer(ssh123,source_file = "netiko_global.log",dest_file = "ciscoiosimage15.6.log",direction = "put",file_system = "disk():")
        print(transfer123)
        print(out123)
